...
for test_mode in all ui privacy-boundary performance prepare-attention verify-attention prepare-recovery-entry verify-recovery-entry prepare-recovery-confirm verify-recovery-confirm; do
