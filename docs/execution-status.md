...
Updated 13 September 2026. The overall completion plan remains partial. The accepted [business-name design](name-visibility-design.md) now permits eventual native blocking, a possible first preview, and retained chats. The earlier pre-display requirement is superseded.
...
Automatic incoming discovery, notification binding/dismissal, an independent incoming attempt after blocking, and physical qualification remain pending. They are not established by the successful native action result or CI.
