...
| Physical integration | Exact environment, sender/receiver consent, profile and confirmation structure, side effects, Stop/interruptions, observed state plus independent delivery. | Sanitized measured qualification record tied to APK hash. No raw messages, trees or invented success. |
