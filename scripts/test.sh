...
"${java_bin}java" -cp "$test_dir" io.github.appunnim.businessgate.policy.DisplaySenderSuite
python3 scripts/check_sender_catalogue.py
python3 scripts/test_encoded_brand.py
